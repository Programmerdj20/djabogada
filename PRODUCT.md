...
- Ejercicio privado, individual, recién iniciado (papeles de desvinculación de la Fiscalía firmados; tarjeta profesional vigente, T.P. 429113, Consejo Seccional de la Judicatura de Antioquia).
...
- Datos que nunca deben publicarse: cédula, fecha de nacimiento, dirección residencial, celulares de referencias personales, e imágenes de la tarjeta profesional o la cédula. El número de tarjeta profesional (429113) sí es publicable y verificable en el Registro Nacional de Abogados.
...
- Nombre y marca: Dra. Daniela Jaramillo — wordmark de marca personal, sin apellido y sin monograma de iniciales. Reemplaza "Daniela Jaramillo Herrera" en todo el sitio (título, footer, JSON-LD, avisos legales) por decisión explícita del cliente; el nombre legal completo sigue siendo el registrado ante el Consejo Seccional de la Judicatura de Antioquia para la tarjeta profesional.
